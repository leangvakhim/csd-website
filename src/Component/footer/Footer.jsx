        ...
        <motion.footer className="bg-black text-white py-8">
            <div className="container mx-auto px-4 border-b mb-5 pb-20 border-gray-500/50">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <motion.div>
                        <h3 className="text-lg font-normal mb-4 pb-4 border-b border-gray-500/50">{currentLang === 1 ? "Our Location" : "ទីតាំងរបស់ពួកយើង"}</h3>
                    ...
                    <motion.div>
                        <h3 className="text-lg font-normal mb-4 pb-4 border-b border-gray-500/50">{currentLang === 1 ? "Our Pages" : "គេហទំព័ររបស់ពួកយើង"}</h3>
                    ...
                    <motion.div>
                        <h3 className="text-lg font-normal mb-4 pb-4 border-b-2 border-gray-500/50">{currentLang === 1 ? "Quick Links" : "តំណរហ័ស"}</h3>
                        <ul className="xl:text-lg text-sm font-light text-gray-300">
